 ...
 */
final class Version20230214192912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activities (id INT AUTO_INCREMENT NOT NULL, owner_id VARCHAR(45) NOT NULL, name VARCHAR(45) NOT NULL, status VARCHAR(45) NOT NULL, photo VARCHAR(255) NOT NULL, category VARCHAR(45) NOT NULL, startdate DATETIME NOT NULL, enddate DATETIME NOT NULL, UNIQUE INDEX UNIQ_B5F1AFE57E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE files (employee_id VARCHAR(45) NOT NULL, referred_id INT NOT NULL, name VARCHAR(45) NOT NULL, date DATETIME NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_63540598C03F15C (employee_id), INDEX IDX_6354059CFE2A98 (referred_id), PRIMARY KEY(employee_id, referred_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
