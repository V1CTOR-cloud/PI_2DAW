 ...
 */
final class Version20230214112357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activities (id INT AUTO_INCREMENT NOT NULL, owner_id VARCHAR(45) NOT NULL, name VARCHAR(45) NOT NULL, status VARCHAR(45) NOT NULL, photo LONGBLOB NOT NULL, category VARCHAR(45) NOT NULL, startdate DATETIME NOT NULL, enddate DATETIME NOT NULL, UNIQUE INDEX UNIQ_B5F1AFE57E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE associated (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, name VARCHAR(45) NOT NULL, photo LONGBLOB NOT NULL, pc INT DEFAULT NULL, loc VARCHAR(45) NOT NULL, prov VARCHAR(45) NOT NULL, bithdate DATETIME NOT NULL, disab_deg INT NOT NULL, disab_type VARCHAR(45) NOT NULL, phone VARCHAR(12) DEFAULT NULL, mail VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employee (email VARCHAR(45) NOT NULL, name VARCHAR(45) NOT NULL, password VARCHAR(45) NOT NULL, profile VARCHAR(45) NOT NULL, photo LONGBLOB NOT NULL, PRIMARY KEY(email)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE files (employee_id VARCHAR(45) NOT NULL, referred_id INT NOT NULL, name VARCHAR(45) NOT NULL, date DATETIME NOT NULL, INDEX IDX_63540598C03F15C (employee_id), INDEX IDX_6354059CFE2A98 (referred_id), PRIMARY KEY(employee_id, referred_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session (associated_id INT NOT NULL, author_id VARCHAR(45) NOT NULL, file LONGBLOB NOT NULL, type VARCHAR(45) NOT NULL, startdate DATETIME NOT NULL, enddate DATETIME NOT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_D044D5D4A347F76E (associated_id), INDEX IDX_D044D5D4F675F31B (author_id), PRIMARY KEY(associated_id, author_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
